                ...
                if (playing)
                {
                    ...
                    while (playing)
                    {
                        ...
                        while (!playingRound && !stop)
                        {
                            ...
                            else if ((inputArray.Length == 2 && inputArray[0] == "deals" && inputArray[1] == "cards") && !cardsDealt)
                            {
                        ...
                        while (playingRound)
                        {
                            ...
                            for (int i = 0; i < playersList.Count; i++)
                            {
                                ...
                                {
                                    Console.WriteLine("the player action is " + PlayersActions[i][j]);
                                    ...
                                    else if (PlayersActions[i][j] == ActionStates.Hit)
                                    {
                                    ...
                                    else if (PlayersActions[i][j] == ActionStates.Stand)
                                    {
                                        //stand
                                    }
                                    else
